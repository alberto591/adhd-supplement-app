...
- **Onboarding**: Grace Period, Medication Safety, Goal Selection, Stack Setup.
- **Dashboard**: Daily Stack, Level Up, Insights.
- **Library**: Supplement browser with drag-and-drop stack building.
- **Streaks**: Saved & Recovery screens.
- **Settings**: Visual Pill Matcher, Persistent Reminders.
- **Safety**: Safety Interaction Detail.
