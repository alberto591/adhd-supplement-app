...
1.  **Rules (`.agent/rules`)**: Enforce personality constraints (e.g., "Focus Expert" ensures low cognitive load UI).
...
**Consequences**:
- **Positive**: Maintains high quality/consistency without mental strain on the developer. specific "Focus Friendly" UI rules are enforced automatically.
