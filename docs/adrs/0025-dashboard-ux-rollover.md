...
- **UI**: Moved the options menu (3-dots) to the top-left of `RoutineCard` for a cleaner interface.

## Consequences
- **Pros**: Matches Focus user behavior (night owls); reduced "clutter" in the UI; enhanced gamification via tactile/audible feedback.
