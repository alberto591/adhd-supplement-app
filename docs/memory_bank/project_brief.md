...
## Success Metrics
- Daily active users completing supplement logging
- Streak retention (30-day milestone completion rate)
- Safety warning engagement rate
- Affiliate link click-through rate

## Project Constraints
- Must be offline-capable (local-first architecture)
- Must pass HIPAA-adjacent privacy standards
- Must support iOS 15+ and Android 10+
- Must align with May 2026 Google Play 16KB page alignment requirements
