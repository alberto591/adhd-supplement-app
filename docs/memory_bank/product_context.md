...
1. **Grace Periods**: Missing a day freezes (not breaks) streaks
2. **Black Box Logging**: Every notification logged so users can check "Did I take this?"
3. **Layered Information**: TL;DR summaries with optional deep-dives
4. **Dopamine Engineering**: Ethical gamification (badges, milestones) without dark patterns
