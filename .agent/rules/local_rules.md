...
- **Build Governance**: To prevent unnecessary CI/CD costs and ensure quality control, all Android and iOS builds MUST be triggered manually via `workflow_dispatch` for now. Do not enable automatic triggers (on push/PR) for build jobs.