...
// Generate Mocks
@GenerateMocks([LogRepository, AuthRepository, RoutinePdfService])
import 'advisor_report_view_model_test.mocks.dart';

void main() {
  late MockLogRepository mockLogRepository;
  late MockAuthRepository mockAuthRepository;
  late MockRoutinePdfService mockPdfService;
  late AdvisorReportViewModel viewModel;
  const String userId = 'test_user';

  setUp(() {
    mockLogRepository = MockLogRepository();
    mockAuthRepository = MockAuthRepository();
    mockPdfService = MockRoutinePdfService();

    viewModel = AdvisorReportViewModel(
  ...
  group('AdvisorReportViewModel Tests', () {
    ...
    test('generatePdf calls service with correct data', () async {
      ...
      when(mockPdfService.generateReport(
        ...
        includeOptimizations: anyNamed('includeOptimizations'),
