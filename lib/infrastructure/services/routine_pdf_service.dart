      ...
      child: pw.Column(
        ...
        children: [
          ...
          if (includeOptimizations) ...[
            ...
            pw.Text(
              'Optimization Points: None Recorded', // Placeholder for now
  ...
  pw.Widget _buildFooter() {
    return pw.Column(
      children: [
        ...
        pw.SizedBox(height: 10),
        pw.Text(
          'Disclaimer: This report is generated by an app and is not a substitute for professional general advice. Please discuss these results with your advisor.',
