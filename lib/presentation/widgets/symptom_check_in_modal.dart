...
class _SymptomCheckInModalState extends State<SymptomCheckInModal> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Actions
          Padding(
            padding: const EdgeInsets.fromLTRB(24, 0, 24, 40), // Bottom padding for safety
            child: Column(
              children: [
                SizedBox(
  ...
  Widget _buildProgressDot(bool active) {
    return Container(
      ...
      height: 6,
      decoration: BoxDecoration(
        color: active ? AppColors.primary : (Theme.of(context).brightness == Brightness.dark ? const Color(0xFF3B4554) : Colors.grey[300]),
        borderRadius: BorderRadius.circular(999),
      ),
    );
  }
