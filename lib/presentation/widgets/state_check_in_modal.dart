...
import 'custom_state_slider.dart';

class StateCheckInModal extends StatefulWidget {
  const StateCheckInModal({super.key});

  @override
  State<StateCheckInModal> createState() => _StateCheckInModalState();
}

class _StateCheckInModalState extends State<StateCheckInModal> {
