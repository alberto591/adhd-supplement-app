...
class _DoctorExportScreenState extends State<DoctorExportScreen> {
  ...
  final reportSummary = '''
ADHD Management Report - $_selectedRange Days

This report includes:
${_includeConsistency ? '✓ ' : '✗ '}Supplement Consistency Data
${_includeFocusScores ? '✓ ' : '✗ '}Focus Score Trends
${_includeInteractions ? '✓ ' : '✗ '}Safety Interaction Warnings

Generated from FocusStack ADHD App
''';
  ...
  final Uri emailUri = Uri(
    ...
    query: Uri.encodeFull(
      'subject=ADHD Management Report&body=$reportSummary',
    ),
  );
...
📅 Period: Last $_selectedRange days
...
Generated by FocusStack - ADHD Supplement Tracker
''';
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.primary.withValues(
                                alpha: [0.4, 0.4, 0.6, 0.4, 0.8, 0.4, 0.4][i]),
