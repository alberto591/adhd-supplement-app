                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: AppColors.streakBlue.withValues(alpha: 0.1),
                              boxShadow: [
                                BoxShadow(
                                  color: AppColors.streakBlue.withValues(alpha: 0.3),
                                  blurRadius: 60,
                                  spreadRadius: 10,
                                ),
                              ],
                    ...
                    const Row(
                      ...
                      children: [
                        Icon(Icons.auto_fix_high, color: AppColors.streakBlue, size: 20),
                        SizedBox(width: 8),
                        Text(
                          'Grace Day Applied',
                          style: TextStyle(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.streakBlue,
                        foregroundColor: Colors.white,
                        elevation: 8,
                        shadowColor: AppColors.streakBlue.withValues(alpha: 0.25),
