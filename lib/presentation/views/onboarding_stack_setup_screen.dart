...
class _OnboardingStackSetupScreenState
    extends State<OnboardingStackSetupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: 'Search supplements (e.g. Omega-3)',
                                  hintStyle: TextStyle(
                                    color: isDark
      ...
      bottomSheet: Container(
        color: isDark ? bgDark.withValues(alpha: 0.95) : bgLight.withValues(alpha: 0.95),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: const Color(0xFF102216), // Dark green text
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                    ),
                    elevation: 0, // Flat look as per detailed design
  ...
  Widget _buildSuggestionCard(
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF064E3B).withValues(alpha: 0.1) : Colors.white,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
            color: isDark
                ? const Color(0xFF064E3B).withValues(alpha: 0.3)
  ...
  Widget _buildRoutineCard(
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF064E3B).withValues(alpha: 0.2) : Colors.white,
